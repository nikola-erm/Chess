...
all: .build/main.o .build/util.o .build/ai__engine.o .build/ai__heuristics.o .build/board__board.o .build/board__board_batch.o .build/board__board_generate_moves.o .build/board__board_init.o .build/board__board_static_init.o .build/board__move_serializer.o .build/genetic__genetic.o
	g++ -o chess.exe .build/main.o .build/util.o .build/ai__engine.o .build/ai__heuristics.o .build/board__board.o .build/board__board_batch.o .build/board__board_generate_moves.o .build/board__board_init.o .build/board__board_static_init.o .build/board__move_serializer.o .build/genetic__genetic.o
...
.build/main.o: main.cpp .build/genetic/genetic.h .build/board/move_serializer.h .build/util.h .build/board/board.h .build/ai/engine.h
...
.build/board__board_static_init.o: board/board_static_init.cpp .build/util.h .build/board/board.h
...
.build/genetic__genetic.o: genetic/genetic.cpp .build/genetic/genetic.h .build/board/move_serializer.h .build/util.h .build/board/board.h .build/ai/engine.h

...
all: .build/main.o .build/util.o .build/ai__engine.o .build/ai__heuristics.o .build/board__board.o .build/board__board_batch.o .build/board__board_generate_moves.o .build/board__board_init.o .build/board__board_static_init.o .build/board__move_serializer.o
	g++ -o chess.exe .build/main.o .build/util.o .build/ai__engine.o .build/ai__heuristics.o .build/board__board.o .build/board__board_batch.o .build/board__board_generate_moves.o .build/board__board_init.o .build/board__board_static_init.o .build/board__move_serializer.o

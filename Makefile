...
all: .build/main.o .build/util.o .build/ai__engine.o .build/ai__estimate_tree_size.o .build/ai__heuristics.o .build/board__board.o .build/board__board_batch.o .build/board__board_generate_moves.o .build/board__board_init.o .build/board__board_static_init.o .build/board__move_serializer.o .build/genetic__genetic.o
...
.build/ai/engine.h: ai/engine.h util.h ai/heuristics.h board/board.h
...
.build/ai/heuristics.h: ai/heuristics.h util.h board/board.h
...
.build/main.o: main.cpp .build/util.h .build/board/move_serializer.h .build/genetic/genetic.h .build/ai/engine.h .build/board/board.h
...
.build/board__board.o: board/board.cpp .build/util.h .build/board/board.h
...
.build/board__board_generate_moves.o: board/board_generate_moves.cpp .build/util.h .build/board/board.h
	g++ $(FLAGS) board/board_generate_moves.cpp -o .build/board__board_generate_moves.o

.build/board__board_init.o: board/board_init.cpp .build/util.h .build/board/board.h
...
.build/genetic__genetic.o: genetic/genetic.cpp .build/util.h .build/board/move_serializer.h .build/genetic/genetic.h .build/ai/engine.h .build/board/board.h
